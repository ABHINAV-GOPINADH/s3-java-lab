    ...
    int empno,emphno;
        public static void main(String args[])
        {
            ...
            for(int i=0;i<n;i++)
            {
                ...
                e[i].name=sc.next();
                System.out.println("Enter the empno of the employee"+(i+1)+":");
            ...
            for(int i=0;i<n;i++)
            {
                ...
                System.out.println("Employee no of employee "+(i+1)+":"+e[i].empno);
                System.out.println("Phone no of employee"+(i+1)+":"+e[i].emphno);
                System.out.println();
            }
        }
}